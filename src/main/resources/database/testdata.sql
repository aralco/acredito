...
#Employee
INSERT INTO Employee(id, active, birthday, code, firstName, idNumber, idType, lastName, password, username, role, version, addressId, officeId)
VALUES (1, '1', '1979-12-12', '1', 'Miguel Angel', '4321234 CBA', 'ID', 'Mendez Perez', 'secret', 'mmendez', 'ADMIN', 1, 1, 1);
